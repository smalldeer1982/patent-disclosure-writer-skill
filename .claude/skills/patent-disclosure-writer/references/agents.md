...
### 23. expert-sr-tech（资深技术专家）

**职责**：评审技术可行性、创新性、技术准确性
...
**输出文件**：
- `.review-modifications-{stage}.json`：修改建议清单
